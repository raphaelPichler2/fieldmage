...
void loadImg(){
  ...
  treeStumpI=loadImage("treeStump.png");
  magicTreeAppleI=loadImage("magicTreeApple.png");
  magicTreeI=loadImage("magicTree.png");
  ...
  carbatteryI = loadImage("carbattery.png");
  ...
  gieskanneI=loadImage("gieskanne.png");
  ...
  blueBoltI = loadImage("blueBolt.png");
