...
void draw(){
  ...
  if(gameMode==0){
    ...
    if(int((time/120)%60)<10) textC("timer: "+int(time/120/60)+":0"+int((time/120)%60),180, 260, 24, 0);
    else textC("timer: "+int(time/120/60)+":"+int((time/120)%60),180, 260, 24, 0);
...
void createMap(){
  ...
  for(int i = 0; i<17500;i++){//+1000 pro item 23*700
  ...
  new Wanderer(+25000,0+400,-25000,0+400,new Rage(0,0));
  
  new Wanderer(0-400,-25000,0-400,+25000,new NinjaDash(0,0));
  new Wanderer(0+400,+25000,0+400,-25000,new WhiteMonster(0,0));
  

  new Wanderer(-18000,-9000-400,+18000,-9000-400,new GiesKanne(0,0));
  new Wanderer(+18000,-9000+400,-18000,-9000+400,new AxeThrow(0,0));
  
  new Wanderer(-18000,9000-400,+18000,9000-400,new AxeThrow(0,0));
  new Wanderer(18000,9000+400,-18000,9000+400,new ItemDice(0,0));
  
  new Wanderer(-9000-400,18000,-9000-400,-18000,new NinjaDash(0,0));
  new Wanderer(-9000+400,-18000,-9000+400,+18000,new Rage(0,0));
  
  new Wanderer(9000-400,18000,9000-400,-18000,new Dash(0,0));
  new Wanderer(9000+400,+18000,9000+400,18000,new WhiteMonster(0,0));
  
  
  new Wanderer(-18000,-17000-400,+18000,-17000-400,new Dash(0,0));
  new Wanderer(+18000,-17000+400,-18000,-17000+400,new ItemDice(0,0));
  
  new Wanderer(-18000,17000-400,+18000,17000-400,new NinjaDash(0,0));
  new Wanderer(18000,17000+400,-18000,-17000+400,new AxeThrow(0,0));
  
  new Wanderer(-17000-400,18000,-17000-400,-18000,new Dash(0,0));
  new Wanderer(-17000+400,-18000,-17000+400,+18000,new WhiteMonster(0,0));
  
  new Wanderer(22000-400,18000,22000-400,-18000,new NinjaDash(0,0));
  new Wanderer(22000+400,+18000,22000+400,18000,new Rage(0,0));
...
void startGame(){
  prey.clear();
  chillPhase=0;
  time=0  +timeChrystal*8*120  + greenChrystal*46*120;//120*60*36
  moneyRound=0;
  enemyBullets.clear();
  bullets.clear();
  items.clear();
