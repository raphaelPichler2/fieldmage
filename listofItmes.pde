...
class ChestBuffer extends GoodItem{
  ChestBuffer(float posX,float posY){
    super(posX,posY);
    name="Pirates chest";
    description = "15% chance to get a green\n"+//6
    "item out of a chest\n"+//6
...
class Craw extends GoodItem{
  Craw(float posX,float posY){
    super(posX,posY);
    name="Craw";
    description = "+6 dmg\n"+//6
    "\n"+//6
  ...
  void drawSkinMap(){
    imageD(rareCrawI,posX,posY,60);
  }
  void drawSkinMenu(float posMX, float posMY){
    image(rareCrawI,posMX,posMY,60,60);
  }
}

class Carbattery extends GoodItem{
  int timer;
  Carbattery(float posX,float posY){
    super(posX,posY);
    name="Carbattery";
    description = " hp\n"+//6
    "every 8 sec shoot\n"+//6
    "4 electric bolt\n"+//6
    "(100% dmg)\n"+//6
    "kills create new bolts";
    timer=(int)random(120*6);
  }
  ...
  void stats2(int itemWave){
    if(itemWave==60){
      ...
      if(timer<=0){
        timer=120*8;
        for(int i=0;i<4;i++){
          new ElectricBolt(player.dmg, player.posX+random(-80,80),player.posY+random(-80,80));
        }
      }
    }
  }
  ...
  void drawSkinMap(){
    imageD(carbatteryI,posX,posY,60);
  }
  void drawSkinMenu(float posMX, float posMY){
    image(carbatteryI,posMX,posMY,60,60);
  }
}
